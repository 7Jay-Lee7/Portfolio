import {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "This web application was created using Vite, React, ThreeJS, Express, Tailwind, and Valtio, that allows users to customize shirts using a 3D AI model generated by OpenAI. The platform provides a highly innovative and responsive solution, enabling users to visualize their custom shirts in a realistic and interactive way.",
      tags: [
        {
          name: "Open AI",
          color: "blue-text-gradient",
    ...
    },
    {
      name: "MERN Dashboard",
      description:
        "I am proud to have developed a responsive web application using the MERN stack, which features an admin dashboard. This dashboard enables users to seamlessly manage data stored in a MongoDB database. The MERN stack provides a robust and comprehensive solution for developing scalable and secure web applications. This project allowed me to demonstrate my expertise in using cutting-edge technologies to deliver efficient and effective solutions.",
      tags: [
        {
          name: "React",
          color: "blue-text-gradient",
